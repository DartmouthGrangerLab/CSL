...
global N_CATS; N_CATS = 2; %number of ground truth classes
global DATASET_NAME; DATASET_NAME = 'higgs';

%Paths for various folders
global ROOT_DIRECTORY; ROOT_DIRECTORY = 'CSLForest';
global ResourcePath; ResourcePath = strcat(ROOT_DIRECTORY, '/HIGGS/'); %Directory where preprocessed dataset is saved.
global OutputPath; OutputPath = strcat(ROOT_DIRECTORY, '/HIGGS/outputHiggs/'); %Where results are saved
